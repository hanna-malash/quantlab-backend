...
def test_volatility_endpoint_reads_normalized_csv(tmp_path: Path) -> None:
    normalized_dir = tmp_path / "normalized"
    normalized_dir.mkdir(parents=True, exist_ok=True)

    (normalized_dir / "BTCUSDT_1h.csv").write_text(
        ...
        "BTCUSDT,2024-01-01T02:00:00+00:00,1,1,1,121,1,cryptodatadownload,1h\n",
        encoding="utf-8",
    )
    ...
    resp = client.get("/api/v1/assets/BTCUSDT/volatility?timeframe=1h&window=2&limit=500")
